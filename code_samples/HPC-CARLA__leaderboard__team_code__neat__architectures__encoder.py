...
class ImageCNN(nn.Module):
    ...
    def __init__(self, vert_anchors, horz_anchors, normalize=True):
        ...
        self.features = models.resnet34(pretrained=False)  # weights come from best_encoder.pth; pretrained=True would trigger a fragile torch-hub download at model construction on the compute node
